  ...
  return (
    <div className='font-poppins'>
      ...
      <div className='h-[316px] w-full bg-components_bg flex justify-center items-center'>
        ...
        <div className='w-full h-[525px] sm:h-[800px] flex justify-between sm:px-[40px]
        px-[100px] py-[72px] sm:flex-col'>
          <div className='w-[817px] sm:w-[420px] h-[216px] flex flex-col justify-between'>
            ...
            <div className='w-full h-[120px] flex justify-between items-center'>
                ...
                height={22} width={21} className='w-[21] h-[22] sm:hidden'></Image>
            </div>
          </div>
