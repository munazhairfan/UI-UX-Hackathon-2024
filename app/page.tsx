    ...
    <div className="font-poppins">
      ...
      sm:justify-between">
        ...
        <div className="w-[121px] h-[49px] border-b-2 border-black">
          <p className="text-[24px] leading-[36px] font-medium md:hidden lg:hidden">Shop Now</p>
        </div>
        </div>
      ...
      <div className="w-full h-[672px] flex justify-center bg-fahad
       sm:flex-col md:flex-col lg:flex-col sm:h-[1200px] sm:p-6">
        <div className="w-[605px] h-[562px] justify-between">
          <div className="w-[550px] h-[350px] sm:w-[430px]">
      ...
      {/* div 3 */}
      <div className="w-full h-[777px] flex flex-col justify-evenly sm:h-[1800px]">
        {/* text div */}
      ...
      {/* div 3 */}
      <div className="w-full h-[639px] bg-fahad flex sm:flex-col">
      ...
      <div className="w-full h-[944px] flex flex-col justify-evenly px-[90px] sm:h-[1400px] sm:px-[40px]">
        ...
        <div className="w-full h-[85px] flex flex-col justify-between">
          <p className="font-medium text-[36px] leading-[54px] text-center">Top Picks For You</p>
          <p className="text-hackathon font-medium leading-6 text-center sm:hidden">Find a bright ideal to suit your taste with our great selection of suspension, floor and table lights.</p>
        </div>
        {/* blog div */}
        <div className="w-full h-[554px] sm:h-[1200px] flex flex-col justify-between">
          <div className="w-full h-[555px] sm:h-[1400px] flex justify-between sm:flex-col">
          {/* blog one */}
          ...
          {/* blog three */}
          <div className="w-[393px] h-[555px] flex flex-col justify-between items-center sm:hidden">
